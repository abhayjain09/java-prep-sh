...
/** NON-TERMINAL expression: combines two sub-expressions with OR. */
public class OrExpression implements DiscountRuleExpression {

    private final DiscountRuleExpression left;
    private final DiscountRuleExpression right;

    public OrExpression(DiscountRuleExpression left, DiscountRuleExpression right) {
        this.left = left;
        this.right = right;
    }
